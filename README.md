...
**by Ian Jeffreys** ([@GitHubian1](https://github.com/GitHubian1))
...
### Live (recommended)
The game is published and playable directly in your browser at:

**https://githubian1.github.io/grok-snake/**

(Just click the link above and enjoy!)

The site is automatically updated on pushes to the `main` branch via GitHub Actions (see the workflow in `.github/workflows/pages.yml`).
...
Created by **Ian Jeffreys** using Grok Build (no reinventing wheels — pure classic Snake that just works).
